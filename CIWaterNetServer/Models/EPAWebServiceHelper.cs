...
{
    public class EPAWebServiceHelper
    {
        # region Variables
        ...
        public EPAWebServiceHelper(Coordinate stPoint)
        {
        ...
        private string[] GetPointInputREST()
        {
            ...
            try
            {
                ...
                if (outputObj.Type == Newtonsoft.Json.Linq.JTokenType.Null)
                {
                    ...
                    {
                        Content = new StringContent(statusMessage),
                        ReasonPhrase = "No data returned from EPA web service for the given outlet location."
                    };
            ...
            catch (WebException ex)
            {
                var resp = new HttpResponseMessage(HttpStatusCode.InternalServerError)
                {
                    ...
                    ReasonPhrase = "Error calling Delineation EPA web service."
                };
            ...
            else
            {
                ...
                {
                    Content = new StringContent("Please select a different point."),
                    ReasonPhrase = "No point returned."
                };
